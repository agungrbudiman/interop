    ...
    <section id="wrapper" class="new-login-register">
        ...
        <div class="new-login-box">
            <div class="white-box">
                ...
                ?>
                <br>
                <h3 class="box-title m-b-0">Sistem Informasi Data Kepegawaian</h3>
                <form class="form-horizontal new-lg-form" id="loginform" method="post" action="signin-check">
                    ...
                    <div class="form-group text-center m-t-20">
                        ...
                        <div class="col-xs-6">
                            <a href="http://localhost/interop/sso?callback_url=http://localhost/interop/sidak/signin-check.php" <button class="btn btn-danger btn-lg btn-block btn-rounded text-uppercase waves-effect waves-light" type="button" name="signin">SSO</button></a>
                        </div>
                    </div>
                </form>
            </div>
